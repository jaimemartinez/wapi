// Portado de Baileys. Cadena de claves del emisor (HMAC con semillas 0x01/0x02).
...
export class SenderChainKey {
  ...
  getSeed() { return this.chainKey; }
  getDerivative(seed, key) { return calculateMAC(key, seed); }
}
